...
#+begin_src emacs-lisp :tangle yes
  ...
  (setq-default mode-line-format
                '(
                  "|"
                  "%e"
                  (:eval (unless (string-match-p "-" mode-line-remote)
                           mode-line-remote))
...
Together with the wonderful ~modus-themes~ and ~denote~ packages, which are not provided by Kudu, Protesilaos Savrou has written the beautiful ~spacious-padding~ package.
