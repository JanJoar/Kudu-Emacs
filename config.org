...
#    along with this program.  If not, see <https://www.gnu.org/licenses/>.#+title: Kudu Emacs

#+author: Joar von Arndt
#+SETUPFILE: https://fniessen.github.io/org-html-themes/org/theme-readtheorg.setup
#+STARTUP: overview
* What is Kudu?
Kudu Emacs is originally my own configuration for GNU Emacs that I've manually tinkiered with to improve my workflow, now turned into a fully fledged system in order to make it more usable to others and give me an excuse for polishing it up.
